...
public class OverworldShrine extends Schematic implements IShrine {
    public OverworldShrine() {
        ...
        add(new Selection(0, -1, 0, BlockTypes.STONEBRICK.getId()));

        // Create the rest
        add(new Selection(-1, 0, 0, BlockTypes.STONE_BRICK_STAIRS.getId()));
        add(new Selection(1, 0, 0, BlockTypes.STONE_BRICK_STAIRS.getId(), (byte) 1));
        add(new Selection(0, 0, -1, BlockTypes.STONE_BRICK_STAIRS.getId(), (byte) 2));
        add(new Selection(0, 0, 1, BlockTypes.STONE_BRICK_STAIRS.getId(), (byte) 3));

        // Safe zone
        add(new Selection(1, -1, 1, BlockTypes.STONEBRICK.getId()));
